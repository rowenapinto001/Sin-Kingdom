...
export const locationConfigs: Record<WorldLocationId, LocationConfig> = {
  ...
  garden: {
    ...
    collisionBox: { x: 3586, y: 3935, width: 226, height: 132 },
    interactionZone: { x: 3500, y: 3848, width: 410, height: 330 },
  },
  doorway: {
    id: 'doorway',
    name: 'Doorway',
    ...
    collisionBox: { x: 4582, y: 4330, width: 198, height: 122 },
    interactionZone: { x: 4498, y: 4248, width: 370, height: 300 },
  },
};
