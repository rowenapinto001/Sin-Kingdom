...
export const locationConfigs: Record<WorldLocationId, LocationConfig> = {
  playerHouse: {
    ...
    collisionBox: { x: 284, y: 2295, width: 222, height: 142 },
    interactionZone: { x: 206, y: 2215, width: 378, height: 320 },
  },
  boatingDock: {
    id: 'boatingDock',
    name: 'Boating',
  ...
  airport: {
    ...
    collisionBox: { x: 288, y: 3138, width: 284, height: 158 },
    interactionZone: { x: 200, y: 3050, width: 460, height: 350 },
  },
  clockTower: {
    id: 'clockTower',
    name: 'Clock Tower',
