...
export const trafficLights: TrafficLightPlacement[] = [
  ...
  { id: 'magic-city-crossing-east', x: 1782, y: 596, rotation: 0, scale: 0.58, side: 'east', collision: true },
  ...
  { id: 'central-crossroad-south', x: 2528, y: 622, rotation: 0, scale: 0.64, side: 'south', collision: true },
  { id: 'party-road-light', x: 3595, y: 488, rotation: 0, scale: 0.58, side: 'north', collision: true },
  { id: 'police-road-light', x: 4806, y: 622, rotation: 0, scale: 0.62, side: 'south', collision: true },
  { id: 'bridge-entry-light-west', x: 1240, y: 1745, rotation: 0, scale: 0.62, side: 'west', collision: true },
  { id: 'bridge-exit-light-east', x: 1486, y: 1870, rotation: 0, scale: 0.62, side: 'east', collision: true },
  { id: 'friends-city-connector-light', x: 1970, y: 1808, rotation: 0, scale: 0.58, side: 'north', collision: true },
  { id: 'player-house-gate-light-left', x: 430, y: 2225, rotation: 0, scale: 0.58, side: 'west', collision: true },
  { id: 'player-house-gate-light-right', x: 580, y: 2335, rotation: 0, scale: 0.58, side: 'east', collision: true },
  ...
  { id: 'airport-road-light', x: 585, y: 3160, rotation: 0, scale: 0.66, side: 'east', collision: true },
  { id: 'garden-district-light', x: 3985, y: 7135, rotation: 0, scale: 0.62, side: 'west', collision: true },
  { id: 'doorway-road-light', x: 4612, y: 8004, rotation: 0, scale: 0.62, side: 'west', collision: true },
  { id: 'far-sea-dock-light', x: 635, y: 7778, rotation: 0, scale: 0.56, side: 'east', collision: true },
];
