...
const intersections: WorldObject[] = [
  ...
  ...createIntersection('intersection-garden-route', { x: 3700, y: 3900 }, ROAD_WIDTH * 1.45),
  ...createIntersection('intersection-doorway', { x: 4680, y: 4395 }, ROAD_WIDTH * 1.35),
  ...
  ...createIntersection('intersection-garden-mid', { x: 3200, y: 3420 }, ROAD_WIDTH * 1.35),
...
export const worldRoadDecorations: RoadDecoration[] = [
  ...
  createCrosswalk('crosswalk-garden', { x: 3700, y: 3900 }, false),
  createCrosswalk('crosswalk-doorway', { x: 4680, y: 4395 }, false),
  ...
  createStreetLamp('lamp-garden-route-a', { x: 3060, y: 3335 }),
  createStreetLamp('lamp-garden-route-b', { x: 3650, y: 3820 }),
  createStreetLamp('lamp-doorway-route-a', { x: 4300, y: 4140 }),
  ...
  createRoadSign('sign-garden', { x: 3530, y: 3828 }, 'GARDEN DISTRICT'),
  createRoadSign('sign-doorway', { x: 4550, y: 4260 }, 'DOORWAY'),
];
