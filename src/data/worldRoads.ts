...
const mainRoads: WorldObject[] = [
  ...
  ...createCurvedRoad('road-clock-palace-link', 'Clock Palace Connector', [
    { x: 2520, y: 4700 },
    { x: 3180, y: 4400 },
    { x: 4200, y: 3650 },
  ], districtRoad),
...
const intersections: WorldObject[] = [
  ...
  ...createIntersection('intersection-clock', { x: 2520, y: 4700 }, ROAD_WIDTH * 1.4),
...
export const worldRoadDecorations: RoadDecoration[] = [
  ...
  createCrosswalk('crosswalk-clock', { x: 2520, y: 4700 }),
  ...
  createTrafficLight('traffic-player-house', { x: 2465, y: 3218 }),
  createTrafficLight('traffic-airport', { x: 624, y: 7032 }),
  createTrafficLight('traffic-mahal', { x: 3984, y: 1498 }),
  createTrafficLight('traffic-police', { x: 4814, y: 492 }),
  createTrafficLight('traffic-pink-palace', { x: 4264, y: 3585 }),
  ...
  createStreetLamp('lamp-central-c', { x: 2585, y: 4540 }),
